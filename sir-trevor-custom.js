  ...
  return (function e(t, n, r) {
  ...
  })(
    {
      ...
      14: [
        ...
        {
          '/Users/andrewwalker/sites/sir-trevor-js/node_modules/lodash.isempty/node_modules/lodash.forown/node_modules/lodash._basecreatecallback/node_modules/lodash._setbinddata/node_modules/lodash._isnative/index.js': 8
        }
      ],
      15: [
        function(require, module, exports) {
        ...
        {
          '/Users/andrewwalker/sites/sir-trevor-js/node_modules/lodash.isempty/node_modules/lodash.forown/node_modules/lodash._basecreatecallback/node_modules/lodash._setbinddata/node_modules/lodash.noop/index.js': 9
        }
      ],
      16: [
        function(require, module, exports) {
      ...
      17: [
        ...
        {
          '/Users/andrewwalker/sites/sir-trevor-js/node_modules/lodash.isempty/node_modules/lodash.forown/node_modules/lodash._basecreatecallback/node_modules/lodash.bind/node_modules/lodash._createwrapper/node_modules/lodash._basebind/node_modules/lodash._basecreate/index.js': 13,
          'lodash._isnative': 18,
          'lodash.isobject': 29,
          'lodash.noop': 19
        }
      ...
      30: [
        ...
        {
          '/Users/andrewwalker/sites/sir-trevor-js/node_modules/lodash.isempty/node_modules/lodash.forown/node_modules/lodash._objecttypes/index.js': 24
        }
      ],
      31: [
        function(require, module, exports) {
      ...
      34: [
        function(require, module, exports) {
          ...
          function template(text, data, options) {
            ...
            try {
              var result = Function(importsKeys, 'return ' + source).apply(
                undefined,
                importsValues
              );
            } catch (e) {
      ...
      39: [
        ...
        {
          'lodash._escapehtmlchar': 40,
          'lodash._reunescapedhtml': 42,
          'lodash.keys': 44
        }
      ],
      40: [
      ...
      43: [
        ...
        {
          '/Users/andrewwalker/sites/sir-trevor-js/node_modules/lodash.template/node_modules/lodash.escape/node_modules/lodash._escapehtmlchar/node_modules/lodash._htmlescapes/index.js': 41
        }
      ],
      44: [
        function(require, module, exports) {
        ...
        {
          '/Users/andrewwalker/sites/sir-trevor-js/node_modules/lodash.isempty/node_modules/lodash.forown/node_modules/lodash.keys/index.js': 25,
          'lodash._isnative': 45,
          'lodash._shimkeys': 46,
          'lodash.isobject': 29
        }
      ...
      46: [
        ...
        {
          '/Users/andrewwalker/sites/sir-trevor-js/node_modules/lodash.isempty/node_modules/lodash.forown/node_modules/lodash.keys/node_modules/lodash._shimkeys/index.js': 27,
          'lodash._objecttypes': 47
        }
      ],
      47: [
        function(require, module, exports) {
          ...
          var keysShim = function keys(object) {
            ...
            if (hasDontEnumBug) {
              ...
              for (var j = 0; j < dontEnums.length; ++j) {
                if (
                  !(skipConstructor && dontEnums[j] === 'constructor') &&
                  has.call(object, dontEnums[j])
                ) {
        ...
        function(require, module, exports) {
          ...
          Object.assign(
            ...
            require('./events'),
            {
              ...
              render: function() {
                this.$el.html('<span class="st-icon"></span>' + _.result(this.block_type, 'title'));
                return this;
              }
            }
          );
 ...
 */
            ...
            Object.assign(
              BlockControls.prototype,
              require('./function-bind'),
              require('./mediated-events'),
              require('./renderable'),
              require('./events'),
              {
      ...
      57: [
        ...
        { './function-bind': 92, './renderable': 99 }
      ],
      58: [
        function(require, module, exports) {
          'use strict';
          ...
          Object.assign(
            ...
            require('./events'),
            {
              ...
              blockLimitReached: function() {
                return (
                  this.options.blockLimit !== 0 && this.blocks.length >= this.options.blockLimit
                );
              },
              ...
              canAddBlockType: function(type) {
                ...
                return !(
                  block_type_limit !== 0 && this._getBlockTypeCount(type) >= block_type_limit
                );
              },

              _setBlocksTypes: function() {
                this.blockTypes = utils.flatten(
                  _.isUndefined(this.options.blockTypes) ? Blocks : this.options.blockTypes
                );
              },
              ...
              _incrementBlockTypeCount: function(type) {
                this.blockCounts[type] = _.isUndefined(this.blockCounts[type])
                  ? 1
                  : this.blockCounts[type] + 1;
              },
              ...
              _getBlockTypeLimit: function(t) {
                ...
                return parseInt(
                  _.isUndefined(this.options.blockTypeLimits[t])
                    ? 0
                    : this.options.blockTypeLimits[t],
                  10
                );
              }
            }
          ...
          (function(global) {
            ...
            Object.assign(
              ...
              require('./renderable'),
              {
                ...
                initialize: function() {
                  this.$el
                    .bind('mousedown touchstart', this.onMouseDown)
      ...
      61: [
        function(require, module, exports) {
          ...
          module.exports = {
            ...
            _loadData: function() {
              utils.log(
                '_loadData is deprecated and will be removed in the future. Please use beforeLoadingData instead.'
              );
              this.beforeLoadingData();
            },
        ...
        { './event-bus': 82, './lodash': 97, './utils': 103 }
      ],
      62: [
        function(require, module, exports) {
          (function(global) {
   ...
   */
              ...
              onBlockRender: function() {
                if (window.SirTrevor.initialLoad) {
                  return;
                }
                this.focus();
              },
              ...
              onDeleteClick: function(ev) {
                ...
                this.$inner
                  .on('click', '.st-block-ui-btn--confirm-delete', onDeleteConfirm.bind(this))
                  .on('click', '.st-block-ui-btn--deny-delete', onDeleteDeny.bind(this));
              },
          ...
          (function(global) {
            ...
            module.exports = {
              ...
              initializeDroppable: function() {
                ...
                this.drop_options = Object.assign(
                  {},
                  config.defaults.Block.drop_options,
                  this.drop_options
                );
            ...
            module.exports = {
              ...
              initializePastable: function() {
                ...
                this.paste_options = Object.assign(
                  {},
                  config.defaults.Block.paste_options,
                  this.paste_options
                );
        ...
        function(require, module, exports) {
          ...
          module.exports = {
            ...
            initializeUploadable: function() {
              ...
              this.upload_options = Object.assign(
                {},
                config.defaults.Block.upload_options,
                this.upload_options
              );
            ...
            module.exports = Block.extend({
              ...
              onDrop: function(transferData) {
                ...
                if (/image/.test(file.type)) {
                  ...
                  this.addMessage('Only image file type type accepted - png/jpeg/jpg');
                }
              }
            });
          }.call(
      ...
      74: [
        function(require, module, exports) {
          ...
          module.exports = Block.extend({
            ...
            toHTML: function(html) {
              html = html.replace(/^ - (.+)$/gm, '<li>$1</li>').replace(/\n/gm, '');
        ...
        { '../block': 63, '../lodash': 97, '../to-html': 101 }
      ],
      75: [
        function(require, module, exports) {
          'use strict';
          ...
          (function(global) {
            ...
            module.exports = Block.extend({
              ...
              validTweetUrl: function(url) {
                return (
                  utils.isURI(url) && url.indexOf('twitter') !== -1 && url.indexOf('status') !== -1
                );
              },
          ...
          module.exports = Block.extend({
            ...
            providers: {
              vimeo: {
                ...
                html:
                  '<iframe src="<%= protocol %>//player.vimeo.com/video/<%= remote_id %>?title=0&byline=0" width="580" height="320" frameborder="0"></iframe>'
              },
              youtube: {
                regex: /(?:http[s]?:\/\/)?(?:www.)?(?:(?:youtube.com\/watch\?(?:.*)(?:v=))|(?:youtu.be\/))([^&].+)/,
                html:
                  '<iframe src="<%= protocol %>//www.youtube.com/embed/<%= remote_id %>" width="580" height="320" frameborder="0" allowfullscreen></iframe>'
              }
            },
            ...
            loadData: function(data) {
              ...
              var aspectRatioClass = source.square
                ? 'with-square-media'
                : 'with-sixteen-by-nine-media';

              this.$editor.addClass('st-block__editor--' + aspectRatioClass).html(
                _.template(source.html, {
                  protocol: protocol,
 ...
 */
            ...
            Object.assign(Editor.prototype, require('./function-bind'), require('./events'), {
              ...
              initialize: function(options) {
                ...
                if (
                  !_.isUndefined(this.options.onEditorRender) &&
   ...
   */
              build: function() {
                ...
                this.block_controls = new BlockControls(
                  this.block_manager.blockTypes,
                  this.mediator
                );
                this.fl_block_controls = new FloatingBlockControls(
                  this.$wrapper,
                  this.ID,
                  this.mediator
                );
   ...
   */
        ...
        },
        {
          ...
          './event-bus': 82,
          './events': 83,
          './extensions/editor-store': 84,
          './floating-block-controls': 87,
          './form-events': 88,
          './format-bar': 89,
          './function-bind': 92,
          './lodash': 97,
 ...
 */
            ...
            Object.assign(Submittable.prototype, {
              ...
              onUploadStop: function(e) {
                this.globalUploadCount =
                  this.globalUploadCount <= 0 ? 0 : this.globalUploadCount - 1;
   ...
   */
            ...
            Object.assign(
              FloatingBlockControls.prototype,
              require('./function-bind'),
              require('./renderable'),
              require('./events'),
              {
                ...
                initialize: function() {
                  this.$el
                    .on('click', this.handleBlockClick)
                    .dropArea()
                    .bind('drop', this.onDrop);

                  this.$wrapper
                    .on('mouseover', '.st-block', this.handleBlockMouseOver)
              ...
              require('./renderable'),
              {
                ...
                highlightSelectedButtons: function() {
                  ...
                  this.$btns.forEach(function($btn) {
                    ...
                    $btn.toggleClass('st-format-btn--is-active', formatter.isActive());
                  }, this);
                },
...
*/
            ...
            window.i18n = {
              t: function(key, options) {
                var parts = key.split(':'),
                  ...
                  part,
                  i;
                obj = Locales[SirTrevor.LANGUAGE || config.language];
      ...
      101: [
        ...
        { './blocks': 73, './formatters': 91, './lodash': 97, './utils': 103 }
      ],
      102: [
        function(require, module, exports) {
          'use strict';
          ...
          module.exports = function(content, type) {
            ...
            if (Blocks.hasOwnProperty(type)) {
              ...
              // Do we have a toMarkdown function?
              if (
                !_.isUndefined(block.prototype.toMarkdown) &&
                _.isFunction(block.prototype.toMarkdown)
              ) {
